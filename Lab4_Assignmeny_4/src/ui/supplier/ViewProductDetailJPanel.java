...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product, Supplier supplier) {
        ...
        else imgLogo.setText("No Product Image");
    ...
    private void initComponents() {
        ...
        btnCommon = new javax.swing.JButton();
        ...
        btnCommon.setText("Add Common Feature");
        btnCommon.setEnabled(false);
        btnCommon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCommonActionPerformed(evt);
            }
        });
...
//        manageProductCatalogJPanel.refreshTable();
    ...
    private void saveFeatures() {
       ...
       for(int i=0; i < model.getRowCount(); i++){
           ...
           currentFeature.setName((String) tblFeatures.getValueAt(i, 0));
    ...
    private void btnCommonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCommonActionPerformed
        List<String> feature = new ArrayList<String>();
        feature = supplier.getCommonFeatures();
        if(feature.size() < 1){
            JOptionPane.showMessageDialog(this,"No Common Features where added by Supplier", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        DefaultTableModel model = (DefaultTableModel) tblFeatures.getModel();
        model.setRowCount(0);
        for(int i=0; i < feature.size(); i++){
           Feature newFeature = product.addNewFeature();
           newFeature.setName(feature.get(i));
           newFeature.setValue("Type value here");
       }
        refreshTable();
    }//GEN-LAST:event_btnCommonActionPerformed
    ...
    private javax.swing.JButton btnCommon;
