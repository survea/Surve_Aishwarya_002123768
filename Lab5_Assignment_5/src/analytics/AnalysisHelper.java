...
public class AnalysisHelper {
    ...
    public void getAverageLikesPerComments() {
        ...
        System.out.println("\nQ1 - Average number of likes per comments: " + likeNumber / commentNumber);
    ...
    public void getPassiveUsers(){
         ...
         Collections.sort(users, new UserMapComparitor(postNumbers));
         System.out.println("\nQ4 - The following users have the least posts: ");
    ...
    public void getPassiveCommentsUsers(){
         ...
         ArrayList<User> users = new ArrayList(data.getUsers().values());
         Collections.sort(users, new UserMapComparitor(commentNumbers));
         System.out.println("\nQ5 - The following users have the least Comments: ");
    ...
    public void getPassiveAndActiveOverallUsers(){
        DataStore data = DataStore.getInstance();
         ...
         ArrayList<User> users = new ArrayList(data.getUsers().values());
         Collections.sort(users, new UserMapComparitor(overallNumbers));
         
         System.out.println("\nQ6 - The following users have overall been passive: ");
